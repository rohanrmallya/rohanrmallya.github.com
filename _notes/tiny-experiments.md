...
I was recommended the book by a detailed post on X that talks about how we often set unrealistically large goals and constantly strive to achieve the goals. The post spoke about how larger goals at an individual level are often counterproductive and are the reason why a lot of folks are stuck in the "rat race". It recommended Tiny Experiments to influence a change in perspective.

## Linear Goals

For the longest time, I had a problem with reducing attention span. The only thing I could sit and do for hours was write code. I could not binge watch a TV show like I used to, sit through a movie unless I was locked in a theatre and reading a book was a far, far dream.
...
Sample from what I found in field notes:
...
- Increased focus
- "Read Later" backlog started reducing
...
- [Tiny Experiments (Book)](https://www.goodreads.com/book/show/214268997-tiny-experiments)
- [Amazon](https://amzn.to/48ZFcCR)
- [Audible](https://www.audible.in/pd/Tiny-Experiments-Audiobook/B0DGJ67HM1)
- [Tiny Experiments: Experimentalist Toolkit](https://nesslabs.com/toolkit)
- Author: [Anne-Laure Le Cunff](https://nesslabs.com/)
