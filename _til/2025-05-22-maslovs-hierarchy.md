...
2. Safety needs (personal security, financial security, health and well-being, etc.)
3. Love and belonging (friendship, family, intimacy, etc.)
4. Esteem needs (self-esteem, confidence, achievement, etc.)
5. Self-actualization (creativity, problem-solving, morality, etc.)
