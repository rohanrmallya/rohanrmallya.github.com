...
I started my journey with Mutual Funds in 2019 and I was always exposed to Direct Funds thanks to the wonderful community [/r/IndiaInvestments](https://reddit.com/r/indiainvestments), [tradingqna](https://tradingqna.com/t/why-invest-in-direct-mutual-funds-on-coin/11738/2) and [Kuvera](https://kuvera.in/).
...
![alt text](/assets/imgs/blog/regular-funds/regular.png)

The similar direct plan has a NAV of 91.46 with an expense ratio of 0.53%

![alt text](/assets/imgs/blog/regular-funds/direct.png)

The difference in expense ratio is what the AMC uses to pay the intermediaries. The commission is annualized and calculated daily based on the formula - `Difference in Expense Ratio x Your Investment Value for the Day / 365`.
...
## When does this _probably_ make sense?
...
3. Consider paying for a [fee-only financial advisor](https://www.feeonlyindia.org/directory/) to build a portfolio for you, if you have a sizable portfolio. Most of your mutual fund investments are long-term and should be goal-oriented, so you will not see drastic changes month-on-month.
4. Read the [Wiki on India Investments](https://www.indiainvestments.wiki/) to understand the basics of Mutual Funds and get on a platform that sells only Direct Mutual Funds!
...
[Check out the Calculator]({{ "/calc/regular-vs-direct" | relative_url }})
